...
const PaymonaBI =() => {
  ...
  for (let index = 0; index <= cardDesc.length; index++) {
    if(index === 0){
      cardDesc[index].innerHTML = 'Узнайте все о своих клиентах.'
    }   
    if(index === 1){
      cardDesc[index].innerHTML = 'Управляйте всеми филиалами с одного окна.' 
    }   
    if(index === 2){
      cardDesc[index].innerHTML = 'Автоматизируйте подготовку данных для анализа'
    }   
  }
