...
const creditScoring = document.getElementById('CreditScoring');
const customerChurn = document.getElementById('CustomerChurn');
const fastSQL = document.getElementById('FastSQL');
const paymonaBI = document.getElementById('PaymonaBI');

const DemandPrediction = () =>{

  

  demandPrediction.style.color = '#03C2EC';
...
const CreditScoring = () =>{
  ...
  creditScoring.style.color = '#03C2EC'
